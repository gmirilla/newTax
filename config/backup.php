...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                // Back up uploaded files only. Application code lives in git.
                'include' => [
        ...
        'destination' => [
             ...
             */
            // Primary: local VPS disk (fast, instant). Secondary: Namecheap SFTP (off-site, free).
            // Add 'r2' or 'b2' here once you have a cloud storage account.
            'disks' => [
                'local',
                'namecheap_sftp',
            ],
    ...
    'notifications' => [
        'notifications' => [
            // Only alert on failures — success notifications are noise at daily frequency.
        ...
        'mail' => [
            'to' => env('BACKUP_ALERT_EMAIL', env('MAIL_FROM_ADDRESS', 'admin@example.com')),
    ...
    'monitor_backups' => [
        [
            'name'         => env('APP_NAME', 'NaijaBooks'),
            'disks'        => ['local'],
            'health_checks' => [
                MaximumAgeInDays::class          => 2,    // Alert if no backup for 2 days
                MaximumStorageInMegabytes::class => 4096, // Alert if over 4GB on local disk
            ],
        ],
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'keep_all_backups_for_days' => 7,   // Keep every backup for 1 week
             ...
             */
            // Hard cap: drop oldest backups before disk fills up
