                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3 text-sm font-medium">
                            ...
                            @if($rr->production_order_id)
                            <a href="{{ route('manufacturing.production.show', $rr->production_order_id) }}"
                               class="ml-1 inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] font-medium bg-purple-100 text-purple-700 hover:bg-purple-200"
                               title="From production order {{ $rr->productionOrder?->order_number }}">
                                ...
                                {{ $rr->productionOrder?->order_number }}
                            </a>
                            @endif
                        </td>
                        <td class="px-4 py-3">
