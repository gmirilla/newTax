{{--
    ...
    Variables expected from parent scope (computed once in app.blade.php):
      $navRole, $canPayroll, $canInventory, $canInventoryReports, $canManufacturing, $canMaintenance,
      $navAlertCount, $navPendingRestocks,
      $navInSales, $navInTax, $navInPayroll,
      $navInInventory, $navInManufacturing, $navInMaintenance, $navInReports, $navInSettings
--}}
@php
